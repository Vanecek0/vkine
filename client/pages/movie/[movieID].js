            ...
            {item.status_code !== 34 ? (
              <>
                <Head>
                  ...
                  <meta property="og:image" content={(item.backdrop_path) != null ? config.w300(item.backdrop_path ? item.backdrop_path : item.poster_path) : ''}></meta>
                  <meta property="og:image:secure_url" content={(item.backdrop_path) != null ? config.w300(item.backdrop_path ? item.backdrop_path : item.poster_path) : ''}></meta>
                  ...
                  <meta name="twitter:image" content={(item.backdrop_path) != null ? config.w300(item.backdrop_path ? item.backdrop_path : item.poster_path) : ''}></meta>
                ...
                <ProgressiveLoader
                  isBackground={true}
                  otherClass={movieDetailStyle.banner}
                ...
                <div className={`mb-3 ${movieDetailStyle.movieContent} container`}>
                  ...
                  <div className={movieDetailStyle.movieContent__info}>
                    ...
                    <div className={movieDetailStyle.genres}>
                      {
                        item.genres && item.genres.slice(0, 5).map((genre, i) => (
                          <span key={i} className={`${movieDetailStyle.genres__item} badge`}>{genre.name}</span>
                        ))
                      }
                    </div>
                    ...
                    <p className='text-secondary'><em>{item.tagline}</em></p>
                ...
                <div className={`${movieDetailStyle.movieDetails} mb-3 container`}>
                  ...
                  {mvtypePath == 'movie' && item.belongs_to_collection != null ?
                    (
                      <CollectionBanner collection_name={item.belongs_to_collection.name || item.belongs_to_collection.title} collection_id={item.belongs_to_collection != null ? item.belongs_to_collection.id : ''} language={language} />
                    )
                    : null}
                  <div className={'mvtv-title mb-3 mt-3'}>
