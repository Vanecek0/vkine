...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>{t('head.defaultTitle')}</title>
        <meta property="og:title" content={t('head.defaultTitle')}></meta>
        ...
        <meta property="og:site_name" content={t('head.defaultTitle')}></meta>
        ...
        <meta property="og:image:alt" content={t('head.defaultTitle')}></meta>
        <meta property="og:image:type" content="image/png"></meta>
        <meta name="twitter:card" content="summary_large_image"></meta>
        <meta name="twitter:image" content="https://www.vkine.cz/vkine_meta.png"></meta>
        <meta name="twitter:title" content={t('head.defaultTitle')}></meta>
      ...
      <div className="container">
        <div className="section mb-5">
          ...
          <CategoriesMvTv mvtvType={mvtvType.movie} title={t('home.nowPlayingMovies')} type={movieType.upcoming} language={language} region={region}></CategoriesMvTv>
        </div>
        <div className="section mb-5">
          <CategoriesMvTv mvtvType={mvtvType.movie} title={t('home.newest')} type={movieType.now_playing} language={language} region={region}></CategoriesMvTv>
        </div>
        <div className="section mb-5">
          <CategoriesMvTv mvtvType={mvtvType.movie} title={t('home.popular')} type={movieType.popular} language={language} region={region}></CategoriesMvTv>
        </div>
        <div className="section mb-5">
          <CategoriesMvTv mvtvType={mvtvType.movie} title={t('home.bestRating')} type={movieType.top_rated} language={language} region={region}></CategoriesMvTv>
        </div>
        ...
        <div className="section mb-5">
          ...
          <CategoriesMvTv mvtvType={mvtvType.tv} title={t('home.nowInTV')} type={tvType.on_the_air} language={language} region={region}></CategoriesMvTv>
        </div>
        <div className="section mb-5">
          <CategoriesMvTv mvtvType={mvtvType.tv} title={t('home.popular')} type={tvType.popular} language={language} region={region}></CategoriesMvTv>
        </div>
        <div className="section mb-5">
          <CategoriesMvTv mvtvType={mvtvType.tv} title={t('home.bestRating')} type={tvType.top_rated} language={language} region={region}></CategoriesMvTv>
        </div>
      </div>
      <div className="container">
